...
# Example usage
json_file_path = 'ieeeicbc24-papers.json'  # Replace with your actual JSON file path
pdf_folder = 'ieeeicbc24-papers'  # Replace with the actual folder containing the PDF files
